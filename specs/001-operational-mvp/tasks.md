...
| The legacy smoke suite (`app.e2e-spec.ts`) monthly-summary case depends on the calendar month (fixture email dated June 2026) | TEST-004 | T036 (transaction-to-dashboard integration tests) |
